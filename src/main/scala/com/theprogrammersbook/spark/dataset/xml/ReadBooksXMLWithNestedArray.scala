package com.theprogrammersbook.spark.dataset.xml

import com.theprogrammersbook.spark.beans.{Books, BooksWithArray}
import com.theprogrammersbook.spark.beans.BooksWithArray
